...
INSERT INTO country_detls VALUES(13, 'Maharashtra', 'Mumbai', 'Cotton', 'Diwali', 'Marathi', 'Mumbai', '3,07,713 km^2', 1125 , 36);
...
SELECT DISTINCT(state_name) FROM country_detls;
